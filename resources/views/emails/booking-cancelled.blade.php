    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #fff; padding: 20px; border: 1px solid #e5e7eb; border-radius: 0 0 8px 8px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr><td style="padding: 8px 0; color: #666;">Total</td><td style="font-weight: bold; color: #dc3545;">Rp {{ number_format($booking->total_price, 0, ',', '.') }}</td></tr>
            </table>
            <p style="margin-top: 20px;">Hubungi admin untuk informasi lebih lanjut.</p>
        </div>
    </div>
</body>
</html>
